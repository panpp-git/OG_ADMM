...
def load_dataloader(num_samples, signal_dim, max_n_freq, min_sep, distance, amplitude, floor_amplitude,
    ...
    frequency_representation,fr_ground = fr.freq2fr(f, xgrid, kernel_type, kernel_param,r,nfreq)
    ...
    dataset = data_utils.TensorDataset(clean_signals, frequency_representation, f,fr_ground)
...
def load_dataloader_fixed_noise(num_samples, signal_dim, max_n_freq, min_sep, distance, amplitude, floor_amplitude,
    ...
    dataset = data_utils.TensorDataset(noisy_signals, clean_signals, frequency_representation, f,fr_ground)
